...
class _ManageServing extends ConsumerState<ManageServing> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:  Text((state.createMode)?"Create Serving":"Update Serving")),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _showEstimatedMacros(notif.getEstimatedMacros(100, state.formInputs.relativeFood)), // #TODO: get estimated macros from the form
                const SizedBox(
                  width: 20,
                ),
                const Divider(
