...
final foodServingLocalServiceProvider =
    Provider<FoodServingLocalService>((ref) {
  final isar = ref.read(isarProvider);
  return FoodServingLocalService(isar: isar);
});
...
class FoodServingLocalService {
  ...
  Future<int> addServing(FoodServingIsar serving) async {
    return await isar.writeTxn(() async {
      return await isar.foodServingIsars.put(serving);
    });
  }

  Future<void> deleteServing(int id) async {
    await isar.writeTxn(() async {
      await isar.foodServingIsars.delete(id);
    });
  }
